...
android {
    ...
    signingConfigs {
        create("FCLKey") {
            ...
            storePassword = pwd ?: "FCL-Debug"
            keyAlias = "FCL-Key"
            keyPassword = pwd ?: "FCL-Debug"
        }
        create("FCLDebugKey") {
    ...
    buildTypes {
        getByName("release") {
            ...
            signingConfig = if (pwd != null) signingConfigs.getByName("FCLKey") else signingConfigs.getByName("FCLDebugKey")
        }
        create("fordebug") {
